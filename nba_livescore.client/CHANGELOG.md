...
- Create Angular project with ng: `ng new NBA_LiveScore.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`NBA_LiveScore.client.esproj`).
